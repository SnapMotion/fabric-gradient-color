...
import { changePicker, getRgbByHue } from "../../helpers";
import { useMouseEvents } from "../../hooks";
import { styles } from "../../styles";

function Picking({ red, green, blue, hue, saturation, value, updateRgb }) {
  ...
  return (
    <div
      style={styles.colorPickerPickerArea}
      ref={pickingAreaRef}
      onMouseDown={onMouseDown}
    >
      <div style={styles.colorPickerValueLayer}>
        <div style={styles.colorPickerSaturationLayer}>
          <div style={{ ...styles.pickerPointer, ...getPointerStyle }} />
        </div>
      </div>
    </div>
  );
