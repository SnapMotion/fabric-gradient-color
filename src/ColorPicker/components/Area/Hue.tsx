...
function Hue({ hue, saturation, value, updateRgb }) {
  const hueRef = useRef();
  ...
  return (
    <div style={styles.hue} onMouseDown={onMouseDown}>
      <div style={styles.hueArea} ref={hueRef}>
        <div style={{ ...pointerStyle, ...styles.pickerPointer }} />
      </div>
    </div>
  );
}
